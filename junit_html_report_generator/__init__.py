...
def create_report(source=None, output=None, template="modern", xml_string=None):
    """
    ...
    Example:
        # From file
        create_report(source="results.xml", output="report.html", template="dark")
    ...
    # Generate HTML
    html_content = generate_html(report_data, template_name=template)
